...
const buttonVariants = cva(
  'group inline-flex items-center justify-center gap-2 whitespace-nowrap font-bold transition-all duration-200 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-400 disabled:pointer-events-none disabled:opacity-50 border-4 border-black uppercase tracking-wide hover-lift',
  {
    variants: {
      variant: {
        primary:
